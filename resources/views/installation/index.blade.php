                    ...
                    @method('post')
                      ...
                      <div class="pl-lg-4 row">
                          <div class="col-md-6 form-group{{ $errors->has('purchase_code') ? ' has-danger' : '' }}">
                              ...
                              <input type="text" name="purchase_code" id="input-purchase_code" class="form-control form-control-alternative{{ $errors->has('purchase_code') ? ' is-invalid' : '' }}" placeholder="{{ __('Purchase Code') }}" value="{{ old('purchase_code', '') }}" autofocus>
